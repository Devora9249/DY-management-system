// import { Box, Typography, TextField, FormControl, InputLabel, Select, MenuItem, RadioGroup, Radio, FormControlLabel, Stack, Paper } from '@mui/material';

// export default function DonationSection({ donation, setDonation }) {
//   const handleChange = (field) => (e) =>
//     setDonation({ ...donation, [field]: e.target.value });
//   console.log(donation, 'donation in comp');
